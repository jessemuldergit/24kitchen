...
| MT.1053: Ensure intune device clean-up rule is configured | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
...
| MT.1070: Restrict device join to selected users/groups or none. | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
...
| MT.1085: Pending approvals for Critical Asset Management should not be present. | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
| MT.1090: Global administrator role should not be added as local administrator on the device during Microsoft Entra join | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
| MT.1091: Registering user should not be added as local administrator on the device during Microsoft Entra join | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
...
| --- | --- |
| ADM Break Glass01 | Giraffe IT | ✅ Pass |
| ADM Jesse Mulder | Giraffe IT | ✅ Pass |
| ADM Michel Melk | Giraffe IT | ✅ Pass |
| ADM Romke Oppedijk | Giraffe IT | ✅ Pass |
| ADM Sander Breijer | Giraffe IT | ✅ Pass |
...
| Display Name | Domain |
| --- | --- |
| Giraffeit.onmicrosoft.com | ✅ Pass |
| giraffe-it.com | ✅ Pass |
| giraffe-it.cloud | ✅ Pass |
| Giraffe-it.eu | ✅ Pass |
| Giraffe-it.nl | ✅ Pass |
...
| --- | --- |
| [Default Sharing Policy](https://admin.exchange.microsoft.com/#/individualsharing/:/individualsharingdetails/1807e6c0-7d05-4f28-9c86-253f70a57115/managedomain) | ✅ Pass |
...
| TrackClicks | ✅ Pass |
| AllowClickThrough | ✅ Pass |
| ScanUrls | ✅ Pass |
| EnableForInternalSenders | ✅ Pass |
...
Well done. The connection filter IP allow list was empty ✅
...
| Policy | Result |
| --- | --- |
| EnableInternalSenderAdminNotification | ✅ Pass |
...
| Check Name | Result |
| --- | --- |
| BccSuspiciousOutboundMail | ✅ Pass |
| NotifyOutboundSpam | ✅ Pass |
...
| --- | --- |
| Enabled | ✅ Pass |
| EnableMailboxIntelligenceProtection | ✅ Pass |
| EnableMailboxIntelligence | ✅ Pass |
| EnableSpoofIntelligence | ✅ Pass |
| PhishThresholdLevel | ✅ Pass |
...
| Giraffe-it.eu | ✅ Pass |  |
| Giraffe-it.nl | ✅ Pass |  |
| Giraffeit.onmicrosoft.com | 🗄️ Skip | Parked domain |
...
| Audit Log | Status |
| --- | --- |
| Admin Audit Log Settings | ✅ Enabled |
...
| Policy | Value | Status |
| --- | --- | --- |
| AllowDropBox | False | ✅ Pass |
| AllowBox | False | ✅ Pass |
| AllowGoogleDrive | False | ✅ Pass |
| AllowShareFile | False | ✅ Pass |
| AllowEgnyte | False | ✅ Pass |
...
| Third-party apps | Block all apps | ✅ Pass |
| Custom apps | Block all apps | ✅ Pass |
...
| ReportJunkToCustomizedAddress | True | ✅ Pass |
| ReportNotJunkToCustomizedAddress | True | ✅ Pass |
| ReportPhishToCustomizedAddress | True | ✅ Pass |
| ReportJunkAddresses | sander.breijer@giraffe-it.com | ✅ Pass |
| ReportNotJunkAddresses | sander.breijer@giraffe-it.com | ✅ Pass |
| ReportPhishAddresses | sander.breijer@giraffe-it.com | ✅ Pass |
| ReportChatMessageEnabled | False | ✅ Pass |
| ReportChatMessageToCustomizedAddressEnabled | True | ✅ Pass |
...
| Setting | Result |
| --- | --- |
| Microsoft Authenticator state | ✅ Pass |
| Included Targets | ✅ Pass |
| Allow use of Microsoft Authenticator OTP set to *No* | ❌ Fail |
| Show application name in push and passwordless notifications status | ✅ Pass | 
| Show application name in push and passwordless notifications included target | ✅ Pass | 
| Show geographic location in push and passwordless notifications status | ✅ Pass | 
| Show geographic location in push and passwordless notifications included target | ✅ Pass | 
...
| NetworkAccessGenerativeAIInsights | ❔ Optional |
...
| --- | --- | --- | --- |
| Giraffeit.onmicrosoft.com () | Verified | Managed | ✅ Pass |
| giraffe-it.com (✔️) | Verified | Managed | ✅ Pass |
| giraffe-it.cloud () | Verified | Managed | ✅ Pass |
| Giraffe-it.eu () | Verified | Managed | ✅ Pass |
| Giraffe-it.nl () | Verified | Managed | ✅ Pass |
...
| --- | --- | --- | --- |
| Global Administrator | user | ADM Break Glass01 | Giraffe IT | ❌ No Expiration |
...
| --- | --- | --- |
| User Administrator | ❌ Fail | ❌ Fail |
| Exchange Administrator | ❌ Fail | ❌ Fail |
| SharePoint Administrator | ❌ Fail | ❌ Fail |
| Application Administrator | ❌ Fail | ❌ Fail |
| Privileged Role Administrator | ❌ Fail | ❌ Fail |
| Cloud Application Administrator | ❌ Fail | ❌ Fail |
| Hybrid Identity Administrator | ❌ Fail | ❌ Fail |
...
| --- | --- | --- | --- | --- |
| Strict Preset Security Policy1766584481384 | True | True | ace, apk, app, appx, ani, & 48 others | ✅ Pass |
| Standard Preset Security Policy1765450055055 | True | True | ace, apk, app, appx, ani, & 48 others | ✅ Pass |
| CIS L2 Attachment Policy | True | True | 7z, a3x, ace, ade, adp, & 182 others | ✅ Pass |
| Default | True | True | ace, apk, app, appx, ani, & 48 others | ✅ Pass |
...
| --- | --- | --- | --- |
| Strict Preset Security Policy1766584481384 | True | AdminOnlyAccessPolicy | ✅ Pass |
| Standard Preset Security Policy1765450055055 | True | AdminOnlyAccessPolicy | ✅ Pass |
| CIS L2 Attachment Policy | True | AdminOnlyAccessPolicy | ✅ Pass |
| Default | True | AdminOnlyAccessPolicy | ✅ Pass |
...
| --- | --- | --- | --- |
| Strict Preset Security Policy1766584481384 | True | True | ✅ Pass |
| Standard Preset Security Policy1765450055055 | True | True | ✅ Pass |
| CIS L2 Attachment Policy | True | True | ✅ Pass |
| Default | True | True | ✅ Pass |
...
| Standard Preset Security Policy1765450053058 | ✅ Pass |
| Strict Preset Security Policy1766584478696 | ✅ Pass |
...
| Policy Name | Result |
| --- | --- |
| Office365 AntiPhish Default | ✅ Pass |
| Standard Preset Security Policy1765450053058 | ✅ Pass |
| Strict Preset Security Policy1766584478696 | ✅ Pass |
...
| --- | --- | --- |
| Default | ✅ Pass | ✅ Pass |
| Standard Preset Security Policy1765450053678 | ✅ Pass | ✅ Pass |
| Strict Preset Security Policy1766584479940 | ✅ Pass | ✅ Pass |
...
| --- | --- | --- |
| Default | ✅ Pass |  |
| Standard Preset Security Policy1765450053678 | ✅ Pass |  |
| Strict Preset Security Policy1766584479940 | ✅ Pass |  |
...
| Standard Preset Security Policy1765450057197 | ✅ Pass |
| Strict Preset Security Policy1766584482636 | ✅ Pass |
...
| --- | --- | --- | --- |
| giraffe-it.cloud | ✅ Pass | Last directive is '-all' | 40.92.0.0/15, 40.107.0.0/16, & ...9 addresses |
| giraffe-it.com | ✅ Pass | Last directive is '-all' | 40.92.0.0/15, 40.107.0.0/16, & ...9 addresses |
| Giraffe-it.eu | ✅ Pass | Last directive is '-all' | 40.92.0.0/15, 40.107.0.0/16, & ...9 addresses |
| Giraffe-it.nl | ✅ Pass | Last directive is '-all' | 40.92.0.0/15, 40.107.0.0/16, & ...9 addresses |
| Giraffeit.onmicrosoft.com | ✅ Pass | Last directive is '-all' | 40.92.0.0/15, 40.107.0.0/16, & ...9 addresses |
...
| --- | --- | --- | --- |
| giraffe-it.cloud | ✅ Pass | 1+ mechanism targets | include:spf.protection.outlook.com |
| giraffe-it.com | ✅ Pass | 1+ mechanism targets | include:spf.protection.outlook.com |
| Giraffe-it.eu | ✅ Pass | 1+ mechanism targets | include:spf.protection.outlook.com |
| Giraffe-it.nl | ✅ Pass | 1+ mechanism targets | include:spf.protection.outlook.com |
...
| --- | --- | --- | --- |
| cloud | ❌ Fail | Failure to obtain record | Aggregate Reports:  |
| cloud | ❌ Fail | Failure to obtain record | Forensic Reports:  |
| com | ❌ Fail | Failure to obtain record | Aggregate Reports:  |
| com | ❌ Fail | Failure to obtain record | Forensic Reports:  |
| Giraffe-it.eu | ✅ Pass |  | Aggregate Reports:  |
| Giraffe-it.eu | ✅ Pass |  | Forensic Reports:  |
| Giraffe-it.nl | ✅ Pass |  | Aggregate Reports:  |
| Giraffe-it.nl | ✅ Pass |  | Forensic Reports:  |
| onmicrosoft.com | 🗄️ Skip | Initial domain ||
...
| --- | --- | --- | --- | --- |
| cloud | ❌ Fail | Failure to obtain record |  |  |
...
| --- | --- | --- |
| DLP - Baseline - EU Sensitive Data | ❌ Fail |  |
...
| --- | --- |
| CIS L2 Attachment Policy | ✅ Pass |
| Default | ✅ Pass |
| Standard Preset Security Policy1765450055055 | ✅ Pass |
| Strict Preset Security Policy1766584481384 | ✅ Pass |
...
| --- | --- | --- |
| CIS L2 Attachment Policy | ✅ Pass | cmd, exe, vbe |
| Default | ✅ Pass | cmd, exe, vbe |
| Standard Preset Security Policy1765450055055 | ✅ Pass | cmd, exe, vbe |
| Strict Preset Security Policy1766584481384 | ✅ Pass | cmd, exe, vbe |
...
➡️ Open [Recommendation - ](https://entra.microsoft.com/#view/Microsoft_AAD_IAM/RecommendationDetails.ReactView/recommendationId/) in the Entra admin portal.
...
Well done. At least one Intune device clean-up rule is configured.
| Name | Platfrom | Days to retire |
| --- | --- | --- |
| Device clean-up rule | all | 135 |
...
Well done. Requiring MFA for device registration is enforced at the tenant level.
...
|---------|-------|-------|
| [Restrict non-admin users from creating tenants](https://entra.microsoft.com/#view/Microsoft_AAD_UsersAndTenants/UserManagementMenuBlade/~/UserSettings/menuId/) | Yes | ✅ |
...
|Setting|Value|Status|
|---|---|---|
|[Users can create security groups](https://entra.microsoft.com/#view/Microsoft_AAD_UsersAndTenants/UserManagementMenuBlade/~/UserSettings/menuId/)|No|✅|
...
Well done. Device join is restricted.

Configuration: Selected users/groups (0 users, 2 groups)

|Setting|Value|Status|
|---|---|---|
|[Users may join devices to Microsoft Entra](https://entra.microsoft.com/#view/Microsoft_AAD_Devices/DevicesMenuBlade/~/DeviceSettings/menuId/Overview)|Selected users/groups can join devices.|✅|
...
| Type | Name |
| --- | --- |
| Group | [grp-intune-users-test](https://portal.azure.com/#view/Microsoft_AAD_IAM/GroupDetailsMenuBlade/~/Overview/groupId/e9d8de64-4a35-46a3-ba05-dace758278b3) |
| Group | [grp-intune-users](https://portal.azure.com/#view/Microsoft_AAD_IAM/GroupDetailsMenuBlade/~/Overview/groupId/a0446f3f-d1a3-4990-a5a2-d82cfea06947) |
...
Well done. No pending approvals for Critical Asset Management are found.
...
|-|-|-|
|Default|7|🗄 Skip|
|Strict Preset Security Policy|5|✅ Pass|
|Standard Preset Security Policy|6|✅ Pass|
...
|-|-|-|
|Default|On|🗄 Skip|
|Strict Preset Security Policy|On|✅ Pass|
|Standard Preset Security Policy|On|✅ Pass|
...
|-|-|-|-|
|Default|ASF Options|Disabled|🗄 Skip|
|Strict Preset Security Policy|ASF Options|Disabled|✅ Pass|
|Standard Preset Security Policy|ASF Options|Disabled|✅ Pass|
...
|-|-|-|-|
|Default|RecipientLimitExternalPerHour|500|✅ Pass|
|Default|RecipientLimitInternalPerHour|1000|✅ Pass|
|Default|RecipientLimitPerDay|1000|✅ Pass|
|Default|ActionWhenThresholdReached|BlockUser|✅ Pass|
...
|-|-|-|
|Default|Quarantine|🗄 Skip|
|Strict Preset Security Policy|Quarantine|✅ Pass|
|Standard Preset Security Policy|Quarantine|✅ Pass|
...
|Policy|Setting|Current Value|Result|
|-|-|-|-|
|Built-In Protection Policy|DeliverMessageAfterScan|True|🗄 Skip|
|Built-In Protection Policy|ScanUrls|True|🗄 Skip|
|Strict Preset Security Policy|DeliverMessageAfterScan|True|✅ Pass|
|Strict Preset Security Policy|ScanUrls|True|✅ Pass|
|Standard Preset Security Policy|DeliverMessageAfterScan|True|✅ Pass|
|Standard Preset Security Policy|ScanUrls|True|✅ Pass|
...
|-|-|-|
|Default|15|🗄 Skip|
|Strict Preset Security Policy|30|✅ Pass|
|Standard Preset Security Policy|30|✅ Pass|
...
|DefaultFullAccessWithNotificationPolicy|ESNEnabled|True|✅ Pass|
...
|-|-|-|
|giraffe-it.cloud|True|✅ Pass|
|Giraffe-it.eu|True|✅ Pass|
|giraffe-it.com|True|✅ Pass|
|Giraffe-it.nl|True|✅ Pass|
...
|-|-|-|
|giraffe-it.cloud|Selector1 CNAME selector1-giraffeit-cloud01i._domainkey.Giraffeit.d-v1.dkim.mail.microsoft|✅ Pass|
|giraffe-it.cloud|Selector2 CNAME selector2-giraffeit-cloud01i._domainkey.Giraffeit.d-v1.dkim.mail.microsoft|✅ Pass|
|Giraffe-it.eu|Selector1 CNAME selector1-Giraffeit-eu01i._domainkey.Giraffeit.e-v1.dkim.mail.microsoft|✅ Pass|
|Giraffe-it.eu|Selector2 CNAME selector2-Giraffeit-eu01i._domainkey.Giraffeit.e-v1.dkim.mail.microsoft|✅ Pass|
|giraffe-it.com|Selector1 CNAME selector1-giraffeit-com01i._domainkey.Giraffeit.d-v1.dkim.mail.microsoft|✅ Pass|
|giraffe-it.com|Selector2 CNAME selector2-giraffeit-com01i._domainkey.Giraffeit.d-v1.dkim.mail.microsoft|✅ Pass|
|Giraffe-it.nl|Selector1 CNAME selector1-Giraffeit-nl01i._domainkey.Giraffeit.e-v1.dkim.mail.microsoft|✅ Pass|
|Giraffe-it.nl|Selector2 CNAME selector2-Giraffeit-nl01i._domainkey.Giraffeit.e-v1.dkim.mail.microsoft|✅ Pass|
...
|-|-|-|
|Default|No Sender Detected|🗄 Skip|
|Strict Preset Security Policy|No Sender Detected|✅ Pass|
|Standard Preset Security Policy|No Sender Detected|✅ Pass|
...
|-|-|-|
|Default|True|🗄 Skip|
|Strict Preset Security Policy|False|✅ Pass|
|Standard Preset Security Policy|False|✅ Pass|
|CIS L2 Attachment Policy|True|❌ Fail|
...
|-|-|-|-|
|Office365 AntiPhish Default|EnableUnauthenticatedSender|True|🗄 Skip|
|Strict Preset Security Policy|EnableUnauthenticatedSender|True|✅ Pass|
|Standard Preset Security Policy|EnableUnauthenticatedSender|True|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|AuthenticationFailAction|MoveToJmf|🗄 Skip|
|Strict Preset Security Policy|AuthenticationFailAction|Quarantine|✅ Pass|
|Standard Preset Security Policy|AuthenticationFailAction|MoveToJmf|✅ Pass|
...
|Policy|Setting|Current Value|Result|
|-|-|-|-|
|Built-In Protection Policy|AllowClickThrough|True|🗄 Skip|
|Strict Preset Security Policy|AllowClickThrough|False|✅ Pass|
|Standard Preset Security Policy|AllowClickThrough|False|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|EnableMailboxIntelligenceProtection|True|🗄 Skip|
|Strict Preset Security Policy|EnableMailboxIntelligenceProtection|True|✅ Pass|
|Standard Preset Security Policy|EnableMailboxIntelligenceProtection|True|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|MailboxIntelligenceProtectionAction|NoAction|🗄 Skip|
|Strict Preset Security Policy|MailboxIntelligenceProtectionAction|Quarantine|🗄 Skip|
|Standard Preset Security Policy|MailboxIntelligenceProtectionAction|MoveToJmf|✅ Pass|
...
|-|-|-|
|Default|No domain available|🗄 Skip|
|Strict Preset Security Policy|No domain available|✅ Pass|
|Standard Preset Security Policy|No domain available|✅ Pass|
...
|-|-|-|
|Default|Allowed sender domains empty|🗄 Skip|
|Strict Preset Security Policy|Allowed sender domains empty|✅ Pass|
|Standard Preset Security Policy|Allowed sender domains empty|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|EnableSimilarDomainsSafetyTips|False|🗄 Skip|
|Strict Preset Security Policy|EnableSimilarDomainsSafetyTips|True|✅ Pass|
|Standard Preset Security Policy|EnableSimilarDomainsSafetyTips|True|✅ Pass|
...
|-|-|-|
|Default|True|🗄 Skip|
|Strict Preset Security Policy|True|✅ Pass|
|Standard Preset Security Policy|True|✅ Pass|
...
|Strict Preset Security Policy|True|✅ Pass|
|Standard Preset Security Policy|True|✅ Pass|
|CIS L2 Attachment Policy|True|✅ Pass|
...
|-|-|-|-|
|Default|SpamAction|MoveToJmf|🗄 Skip|
|Default|PhishSpamAction|MoveToJmf|🗄 Skip|
|Strict Preset Security Policy|SpamAction|Quarantine|✅ Pass|
|Strict Preset Security Policy|PhishSpamAction|Quarantine|✅ Pass|
|Standard Preset Security Policy|SpamAction|MoveToJmf|✅ Pass|
|Standard Preset Security Policy|PhishSpamAction|Quarantine|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|EnableUnusualCharactersSafetyTips|False|🗄 Skip|
|Strict Preset Security Policy|EnableUnusualCharactersSafetyTips|True|✅ Pass|
|Standard Preset Security Policy|EnableUnusualCharactersSafetyTips|True|✅ Pass|
...
|-|-|-|-|
|Built-In Protection Policy|Action|Block|🗄 Skip|
|Strict Preset Security Policy|Action|Block|✅ Pass|
|Standard Preset Security Policy|Action|Block|✅ Pass|
...
|-|-|-|
|Default|MoveToJmf|🗄 Skip|
|Strict Preset Security Policy|Quarantine|✅ Pass|
|Standard Preset Security Policy|MoveToJmf|✅ Pass|
...
|Policy|Setting|Current Value|Result|
|-|-|-|-|
|Built-In Protection Policy|TrackClicks|True|🗄 Skip|
|Strict Preset Security Policy|TrackClicks|True|✅ Pass|
|Standard Preset Security Policy|TrackClicks|True|✅ Pass|
...
|-|-|-|
|Built-In Protection Policy|False|🗄 Skip|
|Strict Preset Security Policy|True|✅ Pass|
|Standard Preset Security Policy|True|✅ Pass|
...
|-|-|-|-|
|Office365 AntiPhish Default|EnableSpoofIntelligence|True|🗄 Skip|
|Strict Preset Security Policy|EnableSpoofIntelligence|True|✅ Pass|
|Standard Preset Security Policy|EnableSpoofIntelligence|True|✅ Pass|
...
|-|-|-|-|
|Default|FileFilter|Enabled with all default file types|🗄 Skip|
|Strict Preset Security Policy|FileFilter|Enabled with all default file types|✅ Pass|
|Standard Preset Security Policy|FileFilter|Enabled with all default file types|✅ Pass|
|CIS L2 Attachment Policy|FileFilter|apk,library|❌ Fail|
...
|-|-|-|
|Office365 AntiPhish Default|2|🗄 Skip|
|Strict Preset Security Policy|4|✅ Pass|
|Standard Preset Security Policy|3|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|EnableMailboxIntelligence|True|🗄 Skip|
|Strict Preset Security Policy|EnableMailboxIntelligence|True|✅ Pass|
|Standard Preset Security Policy|EnableMailboxIntelligence|True|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|EnableTargetedDomainsProtection|False|🗄 Skip|
|Office365 AntiPhish Default|EnableOrganizationDomainsProtection|False|🗄 Skip|
|Office365 AntiPhish Default|TargetedDomainProtectionAction|NoAction|🗄 Skip|
|Strict Preset Security Policy|EnableTargetedDomainsProtection|True|✅ Pass|
|Strict Preset Security Policy|EnableOrganizationDomainsProtection|True|✅ Pass|
|Strict Preset Security Policy|TargetedDomainProtectionAction|Quarantine|✅ Pass|
|Standard Preset Security Policy|EnableTargetedDomainsProtection|True|✅ Pass|
|Standard Preset Security Policy|EnableOrganizationDomainsProtection|True|✅ Pass|
|Standard Preset Security Policy|TargetedDomainProtectionAction|Quarantine|✅ Pass|
...
|-|-|-|-|
|Office365 AntiPhish Default|EnableTargetedUserProtection|False|🗄 Skip|
|Office365 AntiPhish Default|TargetedUserProtectionAction|NoAction|🗄 Skip|
|Strict Preset Security Policy|EnableTargetedUserProtection|True|✅ Pass|
|Strict Preset Security Policy|TargetedUserProtectionAction|Quarantine|✅ Pass|
|Standard Preset Security Policy|EnableTargetedUserProtection|True|✅ Pass|
|Standard Preset Security Policy|TargetedUserProtectionAction|Quarantine|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|EnableSimilarUsersSafetyTips|False|🗄 Skip|
|Strict Preset Security Policy|EnableSimilarUsersSafetyTips|True|✅ Pass|
|Standard Preset Security Policy|EnableSimilarUsersSafetyTips|True|✅ Pass|
...
|-|-|-|-|
|giraffe-it.cloud|No Policy Applying||❌ Fail|
|Giraffe-it.eu|No Policy Applying||❌ Fail|
|Giraffeit.onmicrosoft.com|No Policy Applying||❌ Fail|
|giraffe-it.com|No Policy Applying||❌ Fail|
|Giraffe-it.nl|No Policy Applying||❌ Fail|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|ExcludedSenders|No Sender Detected|🗄 Skip|
|Strict Preset Security Policy|ExcludedSenders|No Sender Detected|✅ Pass|
|Standard Preset Security Policy|ExcludedSenders|No Sender Detected|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|ExcludedDomains|giraffe-it.tech|🗄 Skip|
|Strict Preset Security Policy|ExcludedDomains|giraffe-it.tech|❌ Fail|
|Standard Preset Security Policy|ExcludedDomains|giraffe-it.tech|❌ Fail|
...
|Domain|Policy|Priority|Result|
|-|-|-|-|
|giraffe-it.cloud|Default|Default|✅ Pass|
|Giraffe-it.eu|Default|Default|✅ Pass|
|Giraffeit.onmicrosoft.com|Default|Default|✅ Pass|
|giraffe-it.com|Default|Default|✅ Pass|
|Giraffe-it.nl|Default|Default|✅ Pass|
...
|Domain|Policy|Priority|Result|
|-|-|-|-|
|giraffe-it.cloud|CIS L2 Attachment Policy|0|✅ Pass|
|Giraffe-it.eu|CIS L2 Attachment Policy|0|✅ Pass|
|Giraffeit.onmicrosoft.com|CIS L2 Attachment Policy|0|✅ Pass|
|giraffe-it.com|CIS L2 Attachment Policy|0|✅ Pass|
|Giraffe-it.nl|CIS L2 Attachment Policy|0|✅ Pass|
...
|-|-|-|-|
|giraffe-it.cloud|Yes|Not Required|✅ Pass|
|Giraffe-it.eu|Yes|Not Required|✅ Pass|
|Giraffeit.onmicrosoft.com|Yes|Not Required|✅ Pass|
|giraffe-it.com|Yes|Not Required|✅ Pass|
|Giraffe-it.nl|Yes|Not Required|✅ Pass|
...
|-|-|-|-|
|giraffe-it.cloud|v=spf1 include:spf.protection.outlook.com -all|Yes|✅ Pass|
|Giraffe-it.eu|v=spf1 include:spf.protection.outlook.com -all|Yes|✅ Pass|
|Giraffeit.onmicrosoft.com|v=spf1 include:spf.protection.outlook.com -all|Yes|✅ Pass|
|giraffe-it.com|v=spf1 include:spf.protection.outlook.com -all|Yes|✅ Pass|
|Giraffe-it.nl|v=spf1 include:spf.protection.outlook.com -all|Yes|✅ Pass|
...
|-|-|-|-|
|Built-In Protection Policy|EnableSafeLinksForEmail|True|🗄 Skip|
|Strict Preset Security Policy|EnableSafeLinksForEmail|True|✅ Pass|
|Standard Preset Security Policy|EnableSafeLinksForEmail|True|✅ Pass|
...
|Safe Links policy|Setting|Current Value|Result|
|-|-|-|-|
|Built-In Protection Policy|EnableSafeLinksForTeams|True|🗄 Skip|
|Strict Preset Security Policy|EnableSafeLinksForTeams|True|✅ Pass|
|Standard Preset Security Policy|EnableSafeLinksForTeams|True|✅ Pass|
...
|Safe Links policy|Setting|Current Value|Result|
|-|-|-|-|
|Built-In Protection Policy|EnableSafeLinksForOffice|True|🗄 Skip|
|Strict Preset Security Policy|EnableSafeLinksForOffice|True|✅ Pass|
|Standard Preset Security Policy|EnableSafeLinksForOffice|True|✅ Pass|
...
|Antiphishing Policy|Setting|Current Value|Result|
|-|-|-|-|
|Office365 AntiPhish Default|EnableFirstContactSafetyTips|False|🗄 Skip|
|Strict Preset Security Policy|EnableFirstContactSafetyTips|True|✅ Pass|
|Standard Preset Security Policy|EnableFirstContactSafetyTips|True|✅ Pass|
...
|-|-|-|
|Office365 AntiPhish Default|True|🗄 Skip|
|Strict Preset Security Policy|True|✅ Pass|
|Standard Preset Security Policy|True|✅ Pass|
...
### ❔ MT.1033.0: User should be blocked from using legacy authentication (Sander.breijer@giraffe-it.com)
...
### ❔ MT.1033.1: User should be blocked from using legacy authentication (Adriaan.de.koning@giraffe-it.com)
...
### ❔ MT.1033.2: User should be blocked from using legacy authentication (Michel.Melk@giraffe-it.com)
...
### ❔ MT.1033.3: User should be blocked from using legacy authentication (Website@giraffe-it.com)
...
### ❔ MT.1033.4: User should be blocked from using legacy authentication (Info@giraffe-it.com)
