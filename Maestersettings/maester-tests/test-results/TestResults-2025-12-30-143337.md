...
| CISA.MS.AAD.3.8: Managed Devices SHOULD be required to register MFA. | <img src="https://maester.dev/img/test-result/pill-pass.png" height="25" alt="Passed"/> |
...
| CISA.MS.AAD.8.2: Only users with the Guest Inviter role SHOULD be able to invite guest users. | <img src="https://maester.dev/img/test-result/pill-fail.png" height="25" alt="Failed"/> |
...
Well done. Your tenant has one or more policies that require a compliant or domain joined device for registration:

  - [Require managed device to register MFA](https://entra.microsoft.com/#view/Microsoft_AAD_ConditionalAccess/PolicyBlade/policyId/9a03ad15-8489-4197-9f59-05f10b71b825)
...
These conditional access policies enforce the use of a compliant device :
  ...
  - [Require managed device to register MFA](https://entra.microsoft.com/#view/Microsoft_AAD_ConditionalAccess/PolicyBlade/policyId/9a03ad15-8489-4197-9f59-05f10b71b825?%23view/Microsoft_AAD_ConditionalAccess/ConditionalAccessBlade/~/Policies?=)
...
The following user objects did not have a fallback:
    ...
    User: ADM Break Glass01 | Giraffe IT
        ...
        > Excluded in policy 'Require managed device to register MFA'
...
|Setting|Value|Status|
|---|---|---|
|[Users may join devices to Microsoft Entra](https://entra.microsoft.com/#view/Microsoft_AAD_Devices/DevicesMenuBlade/~/DeviceSettings/menuId/Overview)|All users can join devices.|❌|
